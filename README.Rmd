...
[![Monthly Downloads](https://cranlogs.r-pkg.org/badges/last-month/invitroTKdata?color=7BAFD4)](https://cran.r-project.org/package=invitroTKdata?color=7BAFD4)
[![Total Downloads](https://cranlogs.r-pkg.org/badges/grand-total/invitroTKdata)](https://cran.r-project.org/package=invitroTKdata)
...
**Notification:** *Datasets within this package have all been processed with various prototype versions of the `invitroTKstats` R package. We refer users to the [`invitroTKstats` R package](https://github.com/USEPA/invitroTKstats) and [invitrotkstats_dataproc](https://github.com/USEPA/invitrotkstats_dataproc) GitHub pages to obtain the latest version of the package and original raw data/processing scripts, respectively.*
...
* Installing a local clone of the GitHub repo:
  ...
  1. Go to the GitHub repo for [`invitroTKdata`](https://github.com/USEPA/invitroTKdata).
  ...
  4. In your terminal type `git clone https://github.com/USEPA/invitroTKdata`.
